...
namespace Recode.Data.Migrations
{
    ...
    [Migration("20190913123339_RenameTableCompanies")]
            ...
            modelBuilder.Entity("Recode.Data.AppEntity.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreateById = "seed",
                            DateCreated = new DateTimeOffset(new DateTime(2019, 9, 13, 13, 33, 38, 723, DateTimeKind.Unspecified).AddTicks(8714), new TimeSpan(0, 1, 0, 0, 0)),
                            IsActive = true,
                            IsDeleted = false,
                            RoleName = "VGG_Admin",
                            RoleType = "vgg_admin"
                        ...
                        new
                        {
                            Id = 2L,
                            CreateById = "seed",
                            DateCreated = new DateTimeOffset(new DateTime(2019, 9, 13, 13, 33, 38, 724, DateTimeKind.Unspecified).AddTicks(4324), new TimeSpan(0, 1, 0, 0, 0)),
                            IsActive = true,
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = 3L,
                            CreateById = "seed",
                            DateCreated = new DateTimeOffset(new DateTime(2019, 9, 13, 13, 33, 38, 724, DateTimeKind.Unspecified).AddTicks(4424), new TimeSpan(0, 1, 0, 0, 0)),
                            IsActive = true,
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = 4L,
                            CreateById = "seed",
                            DateCreated = new DateTimeOffset(new DateTime(2019, 9, 13, 13, 33, 38, 724, DateTimeKind.Unspecified).AddTicks(4431), new TimeSpan(0, 1, 0, 0, 0)),
                            IsActive = true,
                            IsDeleted = false,
                            RoleName = "Recruiter",
                            RoleType = "clientuser"

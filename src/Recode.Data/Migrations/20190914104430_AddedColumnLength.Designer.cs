...
namespace Recode.Data.Migrations
{
    ...
    [Migration("20190914104430_AddedColumnLength")]
    partial class AddedColumnLength
    {
            ...
            modelBuilder.Entity("Recode.Data.AppEntity.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreateById = "seed",
                            DateCreated = new DateTimeOffset(new DateTime(2019, 9, 14, 11, 44, 29, 868, DateTimeKind.Unspecified).AddTicks(7667), new TimeSpan(0, 1, 0, 0, 0)),
                            IsActive = true,
                            IsDeleted = false,
                            RoleName = "VGG_Admin",
                            RoleType = "vgg_admin"
                        ...
                        new
                        {
                            Id = 2L,
                            CreateById = "seed",
                            DateCreated = new DateTimeOffset(new DateTime(2019, 9, 14, 11, 44, 29, 868, DateTimeKind.Unspecified).AddTicks(9962), new TimeSpan(0, 1, 0, 0, 0)),
                            IsActive = true,
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = 3L,
                            CreateById = "seed",
                            DateCreated = new DateTimeOffset(new DateTime(2019, 9, 14, 11, 44, 29, 868, DateTimeKind.Unspecified).AddTicks(9980), new TimeSpan(0, 1, 0, 0, 0)),
                            IsActive = true,
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = 4L,
                            CreateById = "seed",
                            DateCreated = new DateTimeOffset(new DateTime(2019, 9, 14, 11, 44, 29, 868, DateTimeKind.Unspecified).AddTicks(9982), new TimeSpan(0, 1, 0, 0, 0)),
                            IsActive = true,
                            IsDeleted = false,
                            RoleName = "Recruiter",
                            RoleType = "clientuser"
